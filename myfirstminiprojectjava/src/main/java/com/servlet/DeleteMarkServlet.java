...
public class DeleteMarkServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        try {
            ...
            out.println("body{margin:0;font-family:Arial;height:100vh;display:flex;justify-content:center;align-items:center;background:linear-gradient(135deg,#ff416c,#ff4b2b);}");
            ...
            out.println("a{display:block;text-decoration:none;margin-top:15px;font-weight:bold;color:#dd2476;font-size:16px;}");
